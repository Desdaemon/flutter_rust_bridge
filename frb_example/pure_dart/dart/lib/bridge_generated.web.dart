...
// Section: api2wire
  ...
  List<dynamic> api2wire_application_settings(ApplicationSettings raw) {
    return [
      ...
      api2wire_opt_application_env(raw.envOptional)
    ];
  }
  ...
  List<dynamic> api2wire_exotic_optionals(ExoticOptionals raw) {
    return [
      api2wire_opt_i32(raw.int32),
      api2wire_opt_i64(raw.int64),
      api2wire_opt_f64(raw.float64),
      api2wire_opt_bool(raw.boolean),
      ...
      api2wire_list_opt_attribute(raw.attributesNullable),
      api2wire_opt_list_opt_attribute(raw.nullableAttributes),
      api2wire_opt_new_type_int(raw.newtypeint)
    ];
  }
  ...
  List<dynamic> api2wire_kitchen_sink(KitchenSink raw) {
    ...
    if (raw is KitchenSink_Optional) {
      return [3, api2wire_opt_i32(raw.field0), api2wire_opt_i32(raw.field1)];
    }
  ...
  @protected
  Object? api2wire_opt_Chrono_Utc(DateTime? raw) {
    return raw == null ? null : api2wire_Chrono_Utc(raw);
  }

  @protected
  Object? api2wire_opt_DartOpaque(Object? raw) {
    return raw == null ? null : api2wire_DartOpaque(raw);
  }

  @protected
  Object? api2wire_opt_HideData(HideData? raw) {
    return raw == null ? null : api2wire_HideData(raw);
  }
  ...
  @protected
  List<dynamic>? api2wire_opt_attribute(Attribute? raw) {
    return raw == null ? null : api2wire_attribute(raw);
  }
  ...
  @protected
  List<dynamic>? api2wire_opt_exotic_optionals(ExoticOptionals? raw) {
    return raw == null ? null : api2wire_exotic_optionals(raw);
  }

  @protected
  double? api2wire_opt_f64(double? raw) {
    return raw == null ? null : api2wire_f64(raw);
  }
  ...
  @protected
  int? api2wire_opt_i32(int? raw) {
    return raw == null ? null : api2wire_i32(raw);
  }
  ...
  @protected
  List<dynamic>? api2wire_opt_new_type_int(NewTypeInt? raw) {
    return raw == null ? null : api2wire_new_type_int(raw);
  }
  ...
  @protected
  Uint8List? api2wire_opt_u8_array_3(U8Array3? raw) {
    return raw == null ? null : api2wire_u8_array_3(raw);
  }
  ...
  @protected
  int? api2wire_opt_weekdays(Weekdays? raw) {
    return raw == null ? null : api2wire_weekdays(raw);
  }
  ...
  @protected
  List<dynamic> api2wire_with_enum(WithEnum raw) {
    return [
      api2wire_weekdays(raw.weekdays),
      api2wire_kitchen_sink(raw.kitchenSink),
      api2wire_new_type_int(raw.wrapper)
    ];
  }
// Section: finalizer
...
class FlutterRustBridgeExampleSingleBlockTestWasmModule implements WasmModule {
  ...
  external dynamic /* void */ wire_handle_string_references(NativePortType port_, String boxed, String arc);

  external dynamic /* void */ wire_handle_slices(NativePortType port_, Uint8List boxed, Uint8List arc);

  external dynamic /* void */ wire_handle_vec_string(NativePortType port_, List<String>? strings);

  external dynamic /* void */ wire_handle_option_delegates(NativePortType port_, Uint8List? array);

  external dynamic /* void */ wire_handle_many_optionals(NativePortType port_, String path, bool? has_header,
      List<String>? columns, int? delimiter, int? skip_rows, int? skip_rows_after_header, int? chunk_size);

  external dynamic /* void */ wire_handle_with_enum(NativePortType port_, List<dynamic> with_enum);
...
class FlutterRustBridgeExampleSingleBlockTestWire
  ...
  void wire_handle_string_references(NativePortType port_, String boxed, String arc) =>
      wasmModule.wire_handle_string_references(port_, boxed, arc);

  void wire_handle_slices(NativePortType port_, Uint8List boxed, Uint8List arc) =>
      wasmModule.wire_handle_slices(port_, boxed, arc);

  void wire_handle_vec_string(NativePortType port_, List<String>? strings) =>
      wasmModule.wire_handle_vec_string(port_, strings);

  void wire_handle_option_delegates(NativePortType port_, Uint8List? array) =>
      wasmModule.wire_handle_option_delegates(port_, array);

  void wire_handle_many_optionals(NativePortType port_, String path, bool? has_header, List<String>? columns,
          int? delimiter, int? skip_rows, int? skip_rows_after_header, int? chunk_size) =>
      wasmModule.wire_handle_many_optionals(
          port_, path, has_header, columns, delimiter, skip_rows, skip_rows_after_header, chunk_size);

  void wire_handle_with_enum(NativePortType port_, List<dynamic> with_enum) =>
      wasmModule.wire_handle_with_enum(port_, with_enum);
